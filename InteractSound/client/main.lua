...
RegisterNetEvent('InteractSound_CL:PlayWithinDistanceCoord')
AddEventHandler('InteractSound_CL:PlayWithinDistanceCoord', function(coords, maxDistance, soundFile, soundVolume)
    local lCoords = GetEntityCoords(GetPlayerPed(-1))
    local eCoords = {}
    eCoords.x = coords.x
    eCoords.y = coords.y
